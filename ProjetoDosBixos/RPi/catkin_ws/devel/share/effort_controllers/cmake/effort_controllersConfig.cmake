...
if("TRUE" STREQUAL "TRUE")
  set(effort_controllers_SOURCE_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/effort_controllers)
  set(effort_controllers_DEVEL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/devel)
  ...
  set(effort_controllers_INSTALL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/install)
...
if(NOT "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/effort_controllers/include " STREQUAL " ")
  set(effort_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/effort_controllers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/effort_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT effort_controllers_NUM_DUMMY_TARGETS)
      set(effort_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::effort_controllers::wrapped-linker-option${effort_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR effort_controllers_NUM_DUMMY_TARGETS "${effort_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::effort_controllers::wrapped-linker-option${effort_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND effort_controllers_LIBRARIES "${interface_target_name}")
