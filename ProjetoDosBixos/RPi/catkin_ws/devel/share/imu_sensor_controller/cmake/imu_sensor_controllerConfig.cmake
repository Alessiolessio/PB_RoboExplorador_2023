...
if("TRUE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/devel)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/install)
...
if(NOT "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/imu_sensor_controller/include " STREQUAL " ")
  set(imu_sensor_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/imu_sensor_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/imu_sensor_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imu_sensor_controller_NUM_DUMMY_TARGETS)
      set(imu_sensor_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imu_sensor_controller::wrapped-linker-option${imu_sensor_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imu_sensor_controller_NUM_DUMMY_TARGETS "${imu_sensor_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imu_sensor_controller::wrapped-linker-option${imu_sensor_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imu_sensor_controller_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(imu_sensor_controller_EXPORTED_TARGETS ${${imu_sensor_controller_dep}_EXPORTED_TARGETS})
endforeach()
