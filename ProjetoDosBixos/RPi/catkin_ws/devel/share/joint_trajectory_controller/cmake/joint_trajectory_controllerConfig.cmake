...
if("TRUE" STREQUAL "TRUE")
  set(joint_trajectory_controller_SOURCE_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/joint_trajectory_controller)
  set(joint_trajectory_controller_DEVEL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/devel)
  ...
  set(joint_trajectory_controller_INSTALL_PREFIX /home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/install)
...
if(NOT "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/joint_trajectory_controller/include;/usr/include " STREQUAL " ")
  set(joint_trajectory_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/joint_trajectory_controller/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/math/Documentos/pb_2023/PB_2023/ProjetoDosBixos/RPi/catkin_ws/src/ros_controllers/joint_trajectory_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT joint_trajectory_controller_NUM_DUMMY_TARGETS)
      set(joint_trajectory_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::joint_trajectory_controller::wrapped-linker-option${joint_trajectory_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR joint_trajectory_controller_NUM_DUMMY_TARGETS "${joint_trajectory_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::joint_trajectory_controller::wrapped-linker-option${joint_trajectory_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND joint_trajectory_controller_LIBRARIES "${interface_target_name}")
...
set(depends "actionlib;angles;control_msgs;control_toolbox;controller_interface;hardware_interface;realtime_tools;roscpp;trajectory_msgs;urdf")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(joint_trajectory_controller_EXPORTED_TARGETS ${${joint_trajectory_controller_dep}_EXPORTED_TARGETS})
endforeach()
